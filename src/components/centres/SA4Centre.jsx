  ...
  return (
    ...
    >
      <div style={{ color: colors.txt, justifyItems: "center" }}>
        <h style={{ fontSize: 30 }}>SA4 Centroids</h>
      </div>
      <div
      ...
      >
        <div>
          <ul style={{ listStyle: "none", padding: 0 }}>
            ...
            <li>
              LOCI_URI21: ABS URI (Uniform Resource Identifier) for the location
            </li>
            ...
            <li>GCC_NAME21: Name of the geographical classification system</li>
      ...
      <div>
        <Link
          to="https://geo145327-staging.s3.ap-southeast-2.amazonaws.com/public/SA4_centres.txt"
          target="_blank"
          download
        ...
        &emsp;
        <Link
          to="https://geo145327-staging.s3.ap-southeast-2.amazonaws.com/public/SA4_centres.xlsx"
          target="_blank"
          download
          style={{ color: colors.txt_2 }}
        >
