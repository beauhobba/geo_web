  ...
  return (
    ...
    >
      ...
      <div style={{ flexDirection: "row", display: "flex",  color: colors.txt_2}}>
              ...
              <Link
                  to="https://geo145327-staging.s3.ap-southeast-2.amazonaws.com/public/SA1_centres.txt"
                  target="_blank"
                  download
              ...
              &emsp;
              <Link
                  to="https://geo145327-staging.s3.ap-southeast-2.amazonaws.com/public/SA1_centres.xlsx"
                  target="_blank"
                  download
                  style={{color: colors.txt_2}}
              >
