      ...
      <div style={{ flexDirection: "row", display: "flex",  color: colors.txt_2}}>
              <div>
                  <ul  style={{ listStyle: 'none', padding: 0 }}>
                      <li>MB_CAT21: Category of the mesh block</li>
                      <li>MB_CODE21: Code of the mesh block</li>
              ...
              &emsp;
              <Link
                  to="https://geo145327-staging.s3.ap-southeast-2.amazonaws.com/public/mesh_centres.xlsx"
                  target="_blank"
                  download
                  style={{color: colors.txt_2}}
              >
...
export default MeshBlockCentre;
